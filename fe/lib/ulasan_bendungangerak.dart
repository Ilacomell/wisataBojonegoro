...
class UlasanBendungangerak extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ulasan Bendungan Gerak'),
      ),
      body: Center(
        child: Padding(
                      ...
                      TableRow(
                        children: [
                          ...
                          TableCell(
                            verticalAlignment:
                                TableCellVerticalAlignment.middle,
                            child: Center(child: Text('Lola')),
                          ),
                          TableCell(
                            verticalAlignment:
                                TableCellVerticalAlignment.middle,
                            child: Center(
                                child: Text('Tempatnya indah dan menakjubkan')),
                          ),
                        ],
                      ),
                    ],
