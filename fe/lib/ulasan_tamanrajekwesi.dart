...
class UlasanTamanrajekwesi extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ulasan Taman Rajekwesi'),
      ),
      body: Center(
        child: Padding(
                      ...
                      TableRow(
                        children: [
                          ...
                          TableCell(
                            ...
                            child: Center(
                                child: Text(
                                    'Tempatnya seru banyak jajanan dan permaina')),
                          ),
                        ],
                      ),
                    ],
